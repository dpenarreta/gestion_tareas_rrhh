...
|---|---|---|
| **NEXO** (producto) | **v1.22.2** | Ver `docs/CHANGELOG.md` para el detalle de qué introdujo cada versión |
...
**Última actualización:** 2026-07-28 (v1.22.2 — Executive Reporting Engine, Parte III del FPS: NOVA — 2 campos faltantes en recomendaciones, profundidad exigida en fortalezas/riesgos/oportunidades, Regla de Lenguaje)
**Autor:** Claude Code
