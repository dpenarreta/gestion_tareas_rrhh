...
|---|---|---|
| **NEXO** (producto) | **v1.144.2** | Ver `docs/CHANGELOG.md` para el detalle de qué introdujo cada versión |
...
**Última actualización:** 2026-08-28 (v1.144.2 — fix: `/admin/users` mostraba
...
**Actualización anterior:** 2026-08-28 (v1.144.1 — cierre del gap
