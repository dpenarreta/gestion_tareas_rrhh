...
|---|---|---|
| **NEXO** (producto) | **v1.22.1** | Ver `docs/CHANGELOG.md` para el detalle de qué introdujo cada versión |
...
**Última actualización:** 2026-07-28 (v1.22.1 — Executive Reporting Engine, Parte II del FPS: gráfico real en Distribución Operativa, integración visual de Analytics Predictivo por colaborador usando el motor existente)
**Autor:** Claude Code
