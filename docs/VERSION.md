...
|---|---|---|
| **NEXO** (producto) | **v1.22.0** | Ver `docs/CHANGELOG.md` para el detalle de qué introdujo cada versión |
...
**Última actualización:** 2026-07-28 (v1.22.0 — Executive Reporting Engine 2.0: snapshot inmutable con Report ID, fecha de corte real, NOVA estructurado en 4 secciones, documento de 11 páginas, backfill certificado del histórico)
**Autor:** Claude Code
