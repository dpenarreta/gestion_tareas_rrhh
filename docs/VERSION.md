...
|---|---|---|
| **NEXO** (producto) | **v1.18.1** | Ver `docs/CHANGELOG.md` para el detalle de qué introdujo cada versión |
...
**Última actualización:** 2026-07-26 (v1.18.1 — Fix: ventana de registro retroactivo incluye el fin de semana inmediato anterior hasta el martes, sin tocar la regla de 2 días laborables; Seguimiento y Proyectos, Fija queda fuera de alcance)
**Autor:** Claude Code
