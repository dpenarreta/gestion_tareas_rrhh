...
|---|---|---|
| **NEXO** (producto) | **v1.144.4** | Ver `docs/CHANGELOG.md` para el detalle de qué introdujo cada versión |
...
**Última actualización:** 2026-08-31 (v1.144.4 — pruebas integrales end-to-end
