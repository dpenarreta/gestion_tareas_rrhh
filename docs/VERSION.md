...
|---|---|---|
| **NEXO** (producto) | **v1.146.2** | Ver `docs/CHANGELOG.md` para el detalle de qué introdujo cada versión |
...
**Última actualización:** 2026-09-01 (v1.146.2 — reemplazo de `confirm()`/
