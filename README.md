...
- 2026-09-11: fix(correo): el envio fallaba por CA raiz faltantes en el servidor (v1.156.0)
- 2026-09-11: fix(sesion): el refresco de tokens revocaba la sesion que intentaba renovar (v1.155.1)
- 2026-09-11: feat(auth): el cambio obligatorio de contrasena ya no deja a nadie encerrado (v1.155.0)
...
- 2026-09-02: fix(security): corrige login de ADMINISTRADOR y 7 hallazgos de IA/datos personales (v1.147.1-v1.147.2)
- 2026-09-01: fix(security): corrige los hallazgos de la auditoria de seguridad (v1.147.0)
...
- 2026-08-03: feat(closure): motor de cierre inteligente con fecha de corte (v1.24.0)
...
- 2026-07-26: fix(activities): permite registro retroactivo de fin de semana hasta el martes
- 2026-07-25: feat(analytics): Sprint Analytics 2.1 - Base Horaria Efectiva y Generador Inteligente de Reportes
- 2026-07-25: feat(reports): Sprint Reportes Ejecutivos 2.0 - informe consolidado como informe ejecutivo
- 2026-07-25: feat(analytics): Sprint Analytics 2.0 - Equilibrio Operativo con interpretacion explicable
- 2026-07-24: feat(quality): agrega verificacion de motivo huerfano y registros retroactivos inconsistentes
...
- 2026-07-24: fix(analytics): isCompletedOnTime compara por día calendario, no por instante UTC crudo
