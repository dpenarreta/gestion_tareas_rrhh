    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-slate-200 flex items-center justify-between">
          <h2 className="text-lg font-bold text-slate-900">Cerrar mes</h2>
        ...
        <div className="p-6 space-y-4">
          {loading && <p className="text-sm text-slate-400 text-center py-4">Cargando resumen…</p>}
            ...
            <>
              ...
              {preview.alreadyClosed ? (
                ...
                <>
                  ...
                  <div className="text-xs text-slate-600 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5">
